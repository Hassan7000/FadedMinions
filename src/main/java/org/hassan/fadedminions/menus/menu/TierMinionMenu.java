...
public abstract class TierMinionMenu implements InventoryHolder {
    ...
    public TierMinionMenu(FadedMinions plugin, Player player,String minionType, List<MinionData> minionDataList, int tier) {
        this.plugin = plugin;
        this.player = player;
